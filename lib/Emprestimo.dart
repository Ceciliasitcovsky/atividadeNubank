        ...
        children: [
          ...
          Card(
            child: ListTile(
              ...
              title: Column(
                children: [
                  Image.asset('assets/image/seguroVida.png'),
                ],
              ),
              subtitle: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      style: ButtonStyle(backgroundColor: MaterialStateProperty.all(const Color(0xFF8A05BE)),), 
                      child: Text("Conhecer", style: TextStyle(color: Colors.white),)),
                    )
                  ],
                ),
              )
